# Mi Juego De Damas - Por: Ivan Sangermano
## Descripcion:
...
Por medio del "Visual Studio Code" se ha implementado HTML5, CSS y proximamente JavaScript para la logica de la pagina Web.
## Commits:
1.HTML.
